...
DATA_PATH=${DATASET_PATH:-${STORAGE_PATH}/dataset/sample_long_32k_sft/qwen3_32b_sample_long_sft_32k_pack_text_document}
PRETRAIN_CHECKPOINT_PATH=${PRETRAIN_CHECKPOINT_PATH:-${STORAGE_PATH}/mbridge_ckpt/Qwen3-32B-mcore}
