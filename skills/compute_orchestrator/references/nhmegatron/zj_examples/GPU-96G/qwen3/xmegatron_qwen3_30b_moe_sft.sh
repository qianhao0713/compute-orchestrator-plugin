...
export PYTHONPATH=${PYTHONPATH}:${ROOT_DIR}/Megatron-LM/${MCORE_VERSION:-core_r0_15_0}:${WORKSPACE_DIR}/Megatron-LM/${MCORE_VERSION:-core_r0_15_0}
...
PRETRAIN_CHECKPOINT_PATH=${PRETRAIN_CHECKPOINT_PATH:-${STORAGE_PATH}/mbridge_ckpt/Qwen3-30B-A3B-mcore}
DATASET_PATH=${DATASET_PATH:-${STORAGE_PATH}/dataset/sample_long_32k_sft/qwen3_30b_sample_long_sft_32k_pack_text_document}
TOKENIZER_PATH=${PRETRAIN_CHECKPOINT_PATH}
...
CACHE_DIR=${CACHE_BASE_DIR}/cache/${WORLD_SIZE}_${TP}_${PP}_${EP}_${ETP}_${CP}_${SP}_${DO}_${PR}_${AC}_${MP_DATASET_TYPE}/${TASK_NAME}-$(date +"%m-%d-%H")
...
if [ $PROFILER = true ]; then
    megatron_options+=" \
          ...
          --tensorboard-dir traces \
          --profile-step-start 2\
          --profile-step-end 3 \
          --profile-ranks 2 10 18 24\
...
if [ $DEBUG_MEMORY = true ]; then
    memory_option="--record-memory-history"
fi

run_cmd="env;torchrun $DISTRIBUTED_ARGS -m xmegatron_ext.pretrain.pretrain_v0_15_0
 ${megatron_options} \
 ${dataset_options} \
 ${pr_options} \
 ${load_options} \
