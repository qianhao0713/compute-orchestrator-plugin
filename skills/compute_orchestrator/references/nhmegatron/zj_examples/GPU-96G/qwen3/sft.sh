...
DATASET_PATH=${DATASET_PATH:-${STORAGE_PATH}/dataset/sample_long_32k_sft/qwen3_sample_32k/qwen3_8b_sample_long_sft_32k_pack_text_document}
...
if [ "${MODEL_SIZE}" = "32B" ] || [ "${MODEL_SIZE}" = "8B" ]; then
...
cat /proc/kunlun/version | tee -a ${LOG_FILE}
