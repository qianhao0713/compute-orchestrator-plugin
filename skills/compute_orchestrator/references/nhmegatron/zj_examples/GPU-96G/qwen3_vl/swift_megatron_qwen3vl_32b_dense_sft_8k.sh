...
PRETRAIN_CHECKPOINT_PATH=${PRETRAIN_CHECKPOINT_PATH:-"/mnt/lhycpfs/lhy/model/Qwen3-VL-32B-Instruct"}
...
export MEGATRON_LM_PATH=/workspace/Megatron-LM/core_r0_15_0/
...
IMAGE_MAX_TOKEN_NUM=1024 \
    ...
    --min_lr 1e-6 \
    --output_dir ${OUTPUT_BASEPATH}/Qwen3-VL-32B-Instruct/ \
