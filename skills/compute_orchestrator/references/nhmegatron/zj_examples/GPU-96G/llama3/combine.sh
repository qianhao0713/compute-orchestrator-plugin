...
export PYTHONPATH=${PYTHONPATH}:${ROOT_DIR}/Megatron-LM/${MCORE_VERSION:-core_r0_10_0}:${ROOT_DIR}/megatron_patch/${MEGATRON_PATCH_VERSION:-megatron_patch_241113}
...
#  ${comm_overlap_option} \
run_cmd="env;torchrun $DISTRIBUTED_ARGS ./V5000/llama3/pretrain_llama.py
 ${megatron_options} \
 ${save_ckpt_options} \
 ${pr_options} \
 ${load_options} \
