...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-${STORAGE_PATH}/model/021-236B-A21B-Base-0212-hf}
DATASET_PATH=${DATASET_PATH:-${STORAGE_PATH}/dataset/sft-cot-10w10w/train}
OUTPUT_DIR=${OUTPUT_DIR:-${ROOT_DIR}/output/021-236B}
...
export _XMLIR_DIST_CHECK_INF_NAN_EXIT=0
...
megatron sft \
    ...
    --decoder_first_pipeline_num_layers ${PP0} \
    --decoder_last_pipeline_num_layers ${PPN} \
