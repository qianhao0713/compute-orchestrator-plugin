...
megatron_plugin_init(use_version="0.12.2", check_version=False)
...
from megatron_patch.model.qwen2.layer_specs import (  # get_gpt_layer_with_transformer_engine_spec,
