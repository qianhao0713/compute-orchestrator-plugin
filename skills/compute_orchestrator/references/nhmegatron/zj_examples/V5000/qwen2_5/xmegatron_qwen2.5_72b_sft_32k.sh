...
#PRETRAIN_CHECKPOINT_PATH=${ROOT_DIR}/../ckpt/Qwen2.5-72B-mcore-TP-${TP}-PP-${PP}
#DATASET_PATH=${STORAGE_PATH}//dataset/sample_long_32k_sft/sample_long_sft_32k_48M.json
DATASET_PATH=${DATASET_PATH:-"${STORAGE_PATH}/dataset/sample_long_32k_sft/qwen25_72b_sample_long_sft_32k_pack_text_document"}
...
data_cache_options=" \
        --data-cache-path $OUTPUT_BASEPATH/qwen25_${MODEL_SIZE}/data_cache"
